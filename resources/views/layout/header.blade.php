<!doctype html>
<html class="no-js" lang="ja" ng-app="oscilloApp">
<head>
  <meta charset="utf-8"/>
  ...
  <link rel="stylesheet" crossorigin="anonymous" integrity="sha256-RYMme8QITYCPWDLzOXswkTsPu1tjeAE2Myb7Kid/JBY="
        href="//cdn.jsdelivr.net/foundation-icons/3.0/foundation-icons.min.css">
...
<div class="dropdown-pane bottom small" id="account-dropdown" data-dropdown data-auto-focus="false">
  <a href="{{ url('/home') }}"><i class="fi-home"></i>
    <small>Home</small>
  </a><br>
  <a href="{{ url('/home/dashboard') }}"><i class="fi-graph-trend"></i>
    <small>Dashboard</small>
  </a><br>
  <a href="{{ url('/settings') }}"><i class="fi-widget"></i>
    <small>settings</small>
  </a>
  <hr>
  <a href="{{ url('/logout') }}"><i class="fi-power"></i>
    <small>Logout</small>
  </a>
</div>
